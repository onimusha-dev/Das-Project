                ...
                <Table className="p">
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className={tableHeadStyle}>Designation</TableHead>
                    ...
                    <TableBody>
                        {tableData.map((tableData) => (
                            <TableRow key={tableData.no}>
                                ...
                                <TableCell className={tableCellStyle}>designation</TableCell>
                                <TableCell>
                                    <NavLink to={"#"} className={`flex-1 underline text-blue-800 block`}>view</NavLink>
                                </TableCell>
                                ...
                                <TableCell className={`${tableCellStyle} underline text-blue-800`}>{tableData.action}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
